...
const careOperationNav=active=>sectionNav('医疗协同',active,[['care-operations','协同总览'],['billing','费用结算'],['outpatient-pharmacy','门诊药房'],['inpatient-pharmacy','住院药房'],['lab-workbench','检验'],['pathology-workbench','病理'],['imaging-workbench','检查影像'],['therapy-workbench','治疗'],['surgery-schedule','手术'],['anesthesia-workbench','麻醉'],['transfusion','输血'],['device-monitoring','设备监护']]);
...
const aiCenterNav=active=>sectionNav('AI 中心',active,[['ai-center','AI 总览'],['ai-assistant','临床助手'],['ai-assistant-policy','助手策略'],['models','模型路由'],['agent-catalog','Agent 设计'],['skill-catalog','Skill'],['tool-catalog','Tool'],['agent-evals','评估发布'],['aiops','运行治理']]);
...
const specificRenderers={
  ...
  'ai-assistant-policy':()=>coveragePage({title:'AI 助手策略与效果治理',sub:'按角色、科室和用例管理主动级别、来源、模型、限频、静默、门禁与停用',rows:'ai',metrics:[['今日提醒','18,426'],['医生回源','72.4%'],['重复抑制','3,182'],['严重漏报','0']],primary:'创建助手策略草稿',risk:'神经内科提醒接受率异常升至 96%',riskBody:'高采纳不等于高质量，已触发机械批准与样本抽查，暂停扩大灰度。'}),
