async page => {
  ...
  const titles = await page.evaluate(() => fetch('/docs/design/ui-delivery/route-titles.json').then(response => response.json()));
  ...
  for (const route of routes) {
    ...
    await page.screenshot({
      path: `/Users/liuhaoxian/Downloads/我的/AI项目/openEMR2026/docs/design/ui-delivery/screens/${route}.png`,
      fullPage: true,
      scale: 'css',
      type: 'png'
    });
