  ...
  <section data-page-root class="content vue-native-page pathway-page">
    ...
    <template v-else-if="workspace.data.value">
      ...
      <template v-else>
        ...
        <div class="pathway-prototype-grid">
