...
export const metricWorkbenches: Record<MetricWorkbenchId, MetricWorkbenchDefinition> = {
  ...
  'research-stats': { id: 'research-stats', metricType: 'RESEARCH_STATS', title: '科研统计分析', subtitle: '基于不可变队列快照进行规模、成员和数据输出统计', perspective: '统计分析', defaultMetrics: ['队列快照', '纳入成员', '平均队列规模', '已输出研究集'], workflow: ['选择快照', '核对纳排口径', '计算统计量', '导出汇总证据'], links: [{ label: '科研中心', to: '/research' }, { label: '研究数据集', to: '/research-dataset' }] },
