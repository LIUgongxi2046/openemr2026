...
export const metricWorkbenches: Record<MetricWorkbenchId, MetricWorkbenchDefinition> = {
  ...
  'research-stats': { id: 'research-stats', metricType: 'RESEARCH_STATS', title: '科研统计分析', subtitle: '从队列、成员与数据申请事实表按登记口径计算，去标识聚合，来源与公式随快照固化', perspective: '统计分析', defaultMetrics: ['队列快照', '纳入成员', '平均队列规模', '已输出研究集'], workflow: ['登记口径', '计算快照', '核对纳排', '导出汇总'], links: [{ label: '科研中心', to: '/research' }, { label: '研究数据集', to: '/research-dataset' }] },
