...
@media(max-width:760px){.page-head{display:grid}.bc-shell{grid-template-columns:1fr}.ledger{max-height:260px;border-right:0;border-bottom:1px solid #d9e2e9}.stage,.workflow-stage{grid-template-columns:1fr}.tools{border-right:0;border-bottom:1px solid #dce5eb}.workflow-tools{display:grid;grid-template-columns:repeat(2,minmax(0,1fr))}.workflow-tools>b,.workflow-tools small{grid-column:1/-1}.workflow-inspector{display:grid;grid-template-columns:1fr;border-left:0}.workflow-inspector header,.workflow-inspector dl,.workflow-inspector section{grid-column:1}.workflow-graph-scroll,.workflow-table-wrap{height:440px}.field-grid,.rule-list{grid-template-columns:1fr}.meta{grid-template-columns:1fr}.scope-table>article{grid-template-columns:1fr 1fr}.runtime-impact{align-items:flex-start}.head-actions{justify-content:flex-start}}
</style>
