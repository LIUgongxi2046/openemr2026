...
.eva-patient-slot { min-width: 0; min-height: 0; }.eva-patient-slot :deep(.eva-patient-picker) { width: 100%; height: 100%; }.eva-side-patient-bar { display: flex; align-items: center; gap: 8px; width: 100%; min-height: 42px; padding: 8px 12px; color: inherit; border: 0; background: #f8fafc; text-align: left; cursor: pointer; }.eva-side-patient-bar span { color: #718397; font-size: 8px; font-weight: 800; }.eva-side-patient-bar strong { color: #244764; font-size: 10px; }.eva-side-patient-bar small { overflow: hidden; color: #617a90; font-size: 8px; text-overflow: ellipsis; white-space: nowrap; }.eva-side-patient-bar i { margin-left: auto; color: #7d90a3; font-size: 12px; font-style: normal; }
