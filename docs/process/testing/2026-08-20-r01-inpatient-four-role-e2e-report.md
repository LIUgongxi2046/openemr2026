...
桌面与 390px 视口检查覆盖角色切换、患者条、四步进度、双列结构化正文、质控动作区、签名时间轴、完成态只读和全局 AI 入口；控制台 `0 error / 0 warning`。视觉结论见 `docs/process/testing/design-audit/2026-08-20-r01-inpatient-four-role/audit.md`。
