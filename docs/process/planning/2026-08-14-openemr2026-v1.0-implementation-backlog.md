...
| A02 | 全局 AI医助小南、主动提醒、听写与动作审批 | 060、120–124 | A01,R01,U01 | P7A | 极高 | IN_PROGRESS；主动提醒、听写与动作审批首切 VERIFIED |
...
### A02 全局 AI医助小南、主动提醒、听写与动作审批

- 目标价值：在所有业务页面提供随处可用但不打扰、不越权的AI医助小南。
- 来源：FR-060/120–124。
