...
- 产品需求：`prd/2026-08-11-openemr2026-v1.0-prd.md`（138 FR / 138 AC）。
- 路由与原型：`prototype/app/`、`ui-delivery/route-design-map.csv`（194 路由，含 70 个专科深页）。
- UI 契约：`ui-delivery/tokens.json`、`ui-delivery/design-system.md`、`ui-delivery/state-matrix.md`。
