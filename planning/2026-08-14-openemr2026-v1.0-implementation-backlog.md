...
- 已验证基线：`opencode-tasks.md` 的门诊病历保存、确定性质控、假模型 AI 候选、人工接受、签署、审计/Outbox 事务记录与隔离恢复核心纵切。
...
- 强制输入：PRD v0.15、HLD、四类 LLD、TRB、`ui-delivery/route-design-map.csv`、目标路由截图和当前源代码。
...
- 输入上下文：`ui-delivery/tokens.json`、design-system、state-matrix、route map、194 张截图、LLD-FRONT。
...
- 输入：`architecture/*hld.md` ADR-008、`*lld-front.md` 9、`ui-delivery/route-design-map.csv`、`prototype/traceability.csv`、`web/src/generated/contracts.ts`。
...
- Vitest 13 files/37 tests、vue-tsc、Vite build、生产包敏感文案扫描、根 `scripts/verify.sh` 和 Playwright 194/194 路由全绿；legacy leaf 从 13 降至 9，lazy React chunk 从 109.98KB 降至 85.56KB gzip。证据见 `testing/2026-08-20-u01-v2-vue-core-slice-report.md`。
...
- `planning/2026-08-14-openemr2026-v1.0-implementation-backlog.md` 的 F01、C01 与关键路径。
- `architecture/2026-08-14-openemr2026-lld-data.md` 9、`*lld-back.md` 10 和生产配置章节。
- `reviews/2026-08-14-openemr2026-trb-review.md` DR-004/005/008、ACT-001/007。
- `contracts/openapi.json`、当前 V1–V29 migration、`web/src/generated/contracts.ts`、`prototype/traceability.csv`、`ui-delivery/route-design-map.csv`。
