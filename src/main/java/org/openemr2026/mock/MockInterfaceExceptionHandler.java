...
@RestControllerAdvice(assignableTypes = MockInterfaceController.class)
final class MockInterfaceExceptionHandler {
    @ExceptionHandler(MockInterfaceException.class)
    ResponseEntity<ApiErrorEnvelope> domainFailure(MockInterfaceException failure) {
